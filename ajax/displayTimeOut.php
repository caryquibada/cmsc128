...
while($row=mysqli_fetch_row($result)){
    echo "<tr>";
        $query="SELECT name from student where student_number='$row[1]'";
        $resname=mysqli_query($connect,$query);
        $name=mysqli_fetch_row($resname);
