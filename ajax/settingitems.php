...
if($computerrow[0]==0){
    ...
    <input type="checkbox" id="chargeComputer"></input><label class="custom-control-label" for="customCheck1">Remind if 1 hour has passed when using computer?</label>
    </div></div>';
}else{
    echo '<div class="col-sm-12"><div class="custom-control custom-checkbox">
    <input type="checkbox" id="chargeComputer" checked></input><label class="custom-control-label" for="customCheck1">Remind if 1 hour has passed when using computer?</label>
    </div></div>';
}
if($confirmrow[0]==0){
    echo '<div class="col-sm-12"><div class="custom-control custom-checkbox">
